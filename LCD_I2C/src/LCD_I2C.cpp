...
void LCD_I2C::init()
{
    ...
    send(0b00110000, true);
    delayMicroseconds(4200);
    send(0b00110000, true);
    delayMicroseconds(150);
    send(0b00110000, true);
    delayMicroseconds(37);
    send(0b00100000, true); // Function Set - 4 bits mode
    delayMicroseconds(37);
    send(0b00101000); // Function Set - 4 bits(Still), 2 lines, 5x8 font
    delayMicroseconds(37);
...
void LCD_I2C::send(uint8_t output, bool initialization)
{
    _output.data = output;
