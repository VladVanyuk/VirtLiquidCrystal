...
public:
   ...
   /*!
    ...
    @note This name initializes the device allocating an I2C address.
   ...
   /*!
    ...
    @note This name sets all the pins of the device in a particular
    direction. This name is useful to set all the pins of the device to be
